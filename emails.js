...
const buildContactEmail = function(name, email, subject, role, msg, lang) {
    let output = `
    <!doctype html>
    <html>
    <head>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#ffffff" style="border-radius: 0 0 3px 3px; padding: 25px;">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif;" mc:edit="Article #1 Copy">
                                                    <h2 style="font-size: 20px; color: #444444; margin: 0; padding-bottom: 10px;">Contactformulier FFM.com</h2>
                                                    <p style="color: #747474; font-size: 16px; line-height: 24px; margin: 0;">
                                                      De volgende persoon heeft het contactformulier ingevuld:
                                                    </p>
                                                    <ul style="list-style:none; text-align:left; font-size: 14px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #747474;">
                                                        <li style="padding-bottom: 5px;">Gekozen taal: ${lang}</li>
                                                        <li style="padding-bottom: 15px;">Rol: ${role}</li>
                                                        <li style="padding-bottom: 5px;">Naam: ${name}</li>
                                                        <li style="padding-bottom: 5px;">Email: ${email}</li>
                                                        <li style="padding-bottom: 5px;">Onderwerp: ${subject}</li>
                                                    </ul>
                                                    <p style="text-align:left; color: #747474; font-size: 16px; line-height: 24px; margin: 0;">
                                                      Bericht: <br />
                                                      ${msg}
                                                    </p>
                                                </td>
...
const buildEbookEmailNL = function() {
    let output = `
    <!doctype html>
    <html>
    <head>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#ffffff" style="border-radius: 0 0 3px 3px; padding: 25px;">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif;" mc:edit="Article #1 Copy">
                                                    <h2 style="font-size: 20px; color: #444444; margin: 0; padding-bottom: 10px;">Hier is je ebook!</h2>
                                                    <p style="color: #747474; font-size: 16px; line-height: 24px; margin: 0;">
                                                    Je hebt op <a href="http://flexforcemonkey.com/">FlexForceMonkey.com</a> een eBook aangevraagd. Hij zit als bijlage bij deze mail!
                                                        <br><br>
                                                        Met vriendelijke groet,<br>
                                                        Het FlexForceMonkey team
                                                    </p>
